...
public class TetrisBoard extends JPanel implements Runnable, KeyListener, MouseListener, ActionListener{
	...
	public static final int ENEMY_AREA = 250;  //상대방의 화면을 보여줄 공간 확보 , millions
	...
	private final int PANEL_WIDTH = maxX*BLOCK_SIZE + MESSAGE_WIDTH + BOARD_X + ENEMY_AREA;  // 게임 창 크키 확장 , millions
	...
	public TetrisBoard(Tetris tetris, GameClient client) {
		...
		comboSpeed.setBounds(PANEL_WIDTH - BLOCK_SIZE*20, 5, 45, 20);
		this.add(comboSpeed);
